<script>
    ...
    export default {
        ...
        computed: {
            ...
            timeStarted() {
                return timeAgo.format(Date.parse(this.game.created_at))
            },
            isFull() {
        ...
        <div class="relative flex items-start space-x-3">
          <div>
            <div class="relative px-1">
              <div class="h-8 w-8 bg-emerald-200 text-emerald-500 rounded-full ring-8 ring-white flex items-center justify-center">
          ...
          <div class="min-w-0 flex-1 py-0">
              <div class="text-sm leading-8 text-gray-500">
                ...
                <span class="mr-0.5">
                  <div href="/" class="relative inline-flex items-center rounded-full border border-gray-300 px-3 py-0.5 text-sm mr-2 ml-2">
                    <span class="absolute flex-shrink-0 flex items-center justify-center">
                      <span class="h-1.5 w-1.5 rounded-full" :class="game.isFull ? 'bg-red-500' : 'bg-green-500'" aria-hidden="true"></span>
                    </span>
                    <span class="ml-3.5 font-medium text-gray-900">{{game.players.length}} / {{game.numberOfSeats}} players</span>
                  </div>
