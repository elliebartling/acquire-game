        ...
        <div class="flex items-center justify-between h-16 px-4 sm:px-0">
          ...
          <div v-else class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              ...
              <router-link v-if="user && user.hasActiveGame" to="/current-game" class="button button-sm hover:text-white primary mr-2 font-medium ml-4">Re-Join Current Game</router-link>
