    ...
    <div class="container mx-auto sm:px-6 lg:px-8">
      <div class="border-b border-gray-700">
        <div class="flex items-center justify-between h-16 px-4 sm:px-0">
          ...
          <div v-if="!user.profile" class="block">
          ...
          <div v-else class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              ...
              <router-link to="/current-game" class="bg-violet-500 text-white hover:bg-violet-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium ml-4">Re-Join Current Game</router-link>
            </div>
          </div>
